...
$aaa.=('
<form id="comp" name="' . 'form' . $idlib . '" method="post" accept-charset="UTF-8" action="' . APP_W . 'carrito/carrito"><input id="comp" type="submit" value="Añadir al Carrito" name="enviar">
